...
#import "XHPhotoBrowserViewCell.h"
#import "XHAsset.h"
...
@interface XHPhotoBrowserViewController ()<UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)viewDidLoad {
    ...
    [self.photoCollectionView registerClass:[XHPhotoBrowserViewCell class] forCellWithReuseIdentifier:kPhotoBrowserViewCellReuseID];
}
...
- (UIButton *)creakNavBtnWithBackgoundImgName:(NSString *)imgName action:(SEL)action {
    ...
    [btn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@_normal", imgName]]
         forState:UIControlStateNormal];
    [btn setImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@_selected", imgName]]
...
- (void)selectPhoto:(UIButton *)checkBtn {
    ...
    XHAsset *asset = self.assetsArray[indexPath.item];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    XHPhotoBrowserViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:kPhotoBrowserViewCellReuseID
...
- (void)setAssetsArray:(NSArray *)assetsArray {
    ...
    [assetsArray enumerateObjectsUsingBlock:^(XHAsset *obj, NSUInteger idx, BOOL * _Nonnull stop) {
        if (obj.isSelected) {
            weakSelf.selectedNo++;
        }
    }];
